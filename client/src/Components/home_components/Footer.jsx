...
export default function Footer() {
  ...
  return (
    <div className="w-[100vw] bg-[#1E1D1D] py-11 px-3">
      <div className="container mx-auto flex flex-col items-center md:flex-row md:flex-wrap w-[90%] justify-between md:items-start">
                    ...
                    <div className="company-desc basis-[25%] flex flex-col items-center md:items-start">
                      <h1 className="text-white my-3 text-2xl">Turboflare</h1>
                      <p className="text-[#605D5D] text-center md:text-left md:text-sm xl:text-lg md:line-clamp-6 xl:line-clamp-none">
                        Explore with confidence at Turboflare. Discover a curated collection
                        of exceptional vehicles, personalized services, and automotive
                        insights. Elevate your driving experience with us, where every
                        journey begins and every detail matters. Join our community of car
                        enthusiasts and embark on the road to unparalleled automotive
                        excellence.
                      </p>
                    </div>
                    ...
                    <div className="site-links basis-[15%] flex flex-col items-center md:items-start">
                      ...
                      <div className={`text flex-col gap-3 items-center md:items-start ${ExpandLinks?"flex":"hidden md:flex"}`}>
                        ...
                        <p className="text-[#898484] md:text-xs xl:text-lg">CRUISE COLLECTION</p>
                        <p className="text-[#898484] md:text-xs xl:text-lg">SUPPORT & SERVICES</p>
                    ...
                    <div className="newsletter fbasis-[15%] flex flex-col items-center md:items-start">
                      ...
                      <div className={`text flex-col gap-3 items-center md:items-start ${ExpandNewsLetter?"flex":"hidden md:flex"}`}>
                        <input type="text" placeholder="NAME" className="px-2 focus:outline-0 py-1 bg-[#2C2A2A] placeholder:text-[#A7A0A0] text-[#A7A0A0] cursor-text text-xs xl:text-lg"/>
                        ...
                        <button className="bg-[#A7A0A0] text-[#2C2A2A] p-1 w-[100%] ">SUBSCRIBE</button>
                      </div>
                    </div>
