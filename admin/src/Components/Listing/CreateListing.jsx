...
export default function CreateListing() {
  ...
  return (
      <div className="flex flex-col items-center p-10 gap-10 w-[85vw] h-[100vh] mt-10">
            <div className="flex gap-10 w-fit mx-auto">
                    <form className="left flex flex-col gap-5 w-[25vw]">
                          <input
                            type="text"
                    ...
                    <div className="right flex flex-col items-center gap-10">
                        ...
                        <div className="flex gap-2 w-full">
                            ...
                            <button onClick={handleImgSubmit} className='p-3 border border-green-700 text-green-700 rounded'>UPLOAD</button>
                        </div>  
                        {carData.imageUrls.length>0 && carData.imageUrls.map((img,index)=>{
                            return <div className='flex justify-between p-1 border items-center w-full' key={index}>
                                        <img src={img} alt="listing img" className='w-28 h-28 object-contain rounded-lg'/>
            ...
            <div className="flex flex-col gap-5 ">
                  <button onClick={()=>{setOpenPopup(true)}} className='p-3 rounded border border-[#959292] text-[#959292] text-center'>ADD VARIANT</button>
                  <button className='p-3 rounded border border-[#959292] text-[#959292] text-center'>CREATE LISTING</button>
            </div>
