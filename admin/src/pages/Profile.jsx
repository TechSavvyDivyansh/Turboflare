...
export default function Profile() {
    ...
    console.log(filePercent,formData);
  ...
  return (
    <div className='p-7 w-[85vw] h-[100vh] flex items-center justify-center'>
        <form className='w-[25vw] flex flex-col items-center gap-4'>
            ...
            <input type="text" id="designation" placeholder='Designation' defaultValue={currentAdmin.designation} className='bg-[#161616] p-3 rounded-lg w-full focus:outline-none text-center placeholder:text-[#b6b6b6]' onChange={handleProfileChange}/>
