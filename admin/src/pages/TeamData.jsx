                  ...
                  <tbody>
                      {teamData.map((team,index)=>{
                          ...
                          return <tr key={index} className='bg-[#161616]'>
                                    <td className={`text-center w-[6%] px-5 ${isEnabled?"text-white":"text-[#4a4a4a]"}`}>{index+1}</td>
                                    ...
                                    <td className={`text-center px-5 ${isEnabled?"text-white":"text-[#4a4a4a]"}`}>{team.designation}</td>
